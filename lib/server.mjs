    ...
    switch (message.method) {
      case 'initialize':
        return jsonRpcResult(message.id, {
          ...
          instructions: 'Use analyze_images for OpenAI image analysis and analyze_video for Gemini video analysis. Do not pass large videos inline; prefer fileData, url, or localPath.',
        });
      case 'tools/list':
