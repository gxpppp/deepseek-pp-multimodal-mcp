...
- `vision_status` - checks OpenAI, Gemini, and SiliconFlow configuration.
...
- `analyze_images_siliconflow` - analyzes one or more images through SiliconFlow chat completions API.
- `analyze_video_siliconflow` - analyzes a video through SiliconFlow chat completions API.
...
SILICONFLOW_IMAGE_MODEL=Qwen/Qwen3-VL-30B-A3B-Instruct
SILICONFLOW_VIDEO_MODEL=Qwen/Qwen3-Omni-30B-A3B-Instruct
